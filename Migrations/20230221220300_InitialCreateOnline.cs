        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conteiners_Empresa_EmpresaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Navios_Empresa_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "Empresa",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VidasConteiner", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VidasConteiner_Conteiners_ConteinerId",
                        column: x => x.ConteinerId,
                        principalTable: "Conteiners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VidasConteiner_Viagens_ViagemId",
                        column: x => x.ViagemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conteiners_EmpresaId",
                table: "Conteiners",
                column: "EmpresaId");

            migrationBuilder.CreateIndex(
                name: "IX_Navios_EmpresaId",
                table: "Navios",
                column: "EmpresaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VidasConteiner_ConteinerId",
                table: "VidasConteiner",
                column: "ConteinerId");

            migrationBuilder.CreateIndex(
                name: "IX_VidasConteiner_ViagemId",
                table: "VidasConteiner",
                column: "ViagemId");
        }
